export const digitalMarketerCoverLetter = ({
  ...
  In these roles, I have crafted marketing technology solutions that were integral to the most ambitious digital transformation projects in the NZ public sector. My use of predictive behavioural models has been instrumental in strategising, developing, and executing SEM and campaign experiences with impressive conversion rates, such as in our most recent category campaign where our team achieved a 12% conversion rate.
  
  My expertise extends to managing large digital campaigns and taking product ownership over customer facing platforms – I worked with a large range of stakeholders and 1 direct report in my last 2 cross-functional teams to manage the development of a number of digital products; including an assistant that has been used by over 100,000 learners in vocational education, a recommendation algorithm that boosted learner trust in their options, and much more. I have also developed a number of internal tools to automate and optimise marketing processes, including pipelines for our customer data platform that have enabled us to cohere 24 training institutions into a single network experience.
  
  I am excited about the opportunity to bring my background in leveraging technology for strategic marketing initiatives. I look forward to the possibility of discussing how my skills, experience, and vision align with your objectives.
