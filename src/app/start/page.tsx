...
export default function App(props: IAppProps) {
  return (
    <div className="h-lvh grid place-items-center overflow-hidden">
      <div className="text-center mt-16">
        <h1 className="font-bold text-4xl max-w-xl text-neutral-800">Let's start with a basic CV</h1>
      ...
      <div>
        <div className="max-w-[576px] flex justify-between my-8 mx-auto">
          ...
          <DarkNeumorphButton onClick={() => {}}>Next</DarkNeumorphButton>
        </div>
